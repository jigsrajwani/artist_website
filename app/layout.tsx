...
export const metadata: Metadata = {
  ...
  description: "DJ HPO is Jaipur's viral mashup artist & professional event DJ. 300M+ views, 100+ events performed in Rajasthan. Book for weddings, parties, corporate events. Download mashup packs. @mashbyhpo",
  keywords: [
    "DJ HPO",
    "mashup artist",
    "viral mashups",
  ...
  openGraph: {
    ...
    description: "Jaipur's viral mashup artist & professional DJ. 300M+ views. Book for weddings, corporate events & parties across Rajasthan.",
    siteName: "DJ HPO",
    type: "website",
  ...
  twitter: {
    ...
    description: "Creating high-energy viral mashups. 300M+ views.",
    images: ["/artist.jpg"],
  },
  robots: {
    index: true,
    ...
    "@graph": [
      {
        ...
        "description": "DJ HPO is a viral mashup artist based in Jaipur, Rajasthan, creating high-energy Bollywood & EDM mashups with 300M+ views. Available for weddings, corporate events and private parties.",
        "foundingLocation": {
          "@type": "Place",
