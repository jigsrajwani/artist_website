...
const stats = [
  { label: 'Instagram Followers', value: statsData.instagramFollowers, suffix: statsData.instagramFollowersSuffix },
  { label: 'Total Reel Views',    value: statsData.totalReelViews,  suffix: statsData.totalReelViewsSuffix },
  { label: 'YouTube Subscribers', value: statsData.youtubeSubscribers ?? 108, suffix: statsData.youtubeSubscribersSuffix ?? 'K+' },
  { label: 'Events Performed',    value: statsData.eventsPerformed ?? 100, suffix: statsData.eventsPerformedSuffix ?? '+' },
];
    ...
    >
      ...
      <div style={{ position: 'relative', zIndex: 10, width: '100%', maxWidth: '90rem', margin: '0 auto', padding: '6rem 2rem 4rem', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '3rem', alignItems: 'center' }} className="hero-grid">
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          {/* Instagram badge */}
          <a className="hero-badge" href="https://www.instagram.com/mashbyhpo/" target="_blank" rel="noopener noreferrer" style={{
