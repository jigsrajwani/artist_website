...
const achievements = [
  ...
  { icon: '🎤', value: '50+', label: 'Events Performed' },
  { icon: '🔥', value: '100+', label: 'Viral Mashups Created' },
  { icon: '🌏', value: '10+', label: 'Cities Reached' },
];
            ...
            <div style={{
              ...
              <div style={{ position: 'relative', width: '160px', height: '160px', margin: '0 auto 1.5rem' }}>
                ...
                <div style={{
                  ...
                  borderRadius: '50%',
                  background: 'linear-gradient(135deg, rgba(0,212,255,0.2) 0%, rgba(139,92,246,0.3) 100%)',
                  border: '1px solid rgba(0,212,255,0.2)',
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                }}>
                  <div>
                    <div style={{ fontFamily: 'Outfit, sans-serif', fontWeight: 900, fontSize: '2rem', background: 'linear-gradient(135deg, #00D4FF, #8B5CF6)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>HPO</div>
                    <div style={{ fontSize: '0.65rem', color: '#00D4FF', fontWeight: 600, letterSpacing: '0.2em' }}>DJ</div>
                  </div>
                </div>
                {/* Glow */}
                <div style={{ position: 'absolute', inset: 0, borderRadius: '50%', background: 'rgba(0,212,255,0.06)', filter: 'blur(16px)' }} />
              </div>

              {/* Name */}
              <h3 style={{ color: 'white', fontWeight: 900, fontSize: '1.5rem', fontFamily: 'Outfit, sans-serif', marginBottom: '0.25rem' }}>DJ HPO</h3>
              <p style={{ color: '#00D4FF', fontSize: '0.875rem', fontWeight: 600, letterSpacing: '0.08em', marginBottom: '1.5rem' }}>@mashbyhpo</p>
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', marginBottom: '1.75rem' }}>
              <p style={{ color: 'rgba(209,213,219,1)', lineHeight: 1.7, fontSize: '0.95rem' }}>
                DJ HPO is a viral mashup artist based in India, known for creating high-energy Bollywood and EDM mashups that have taken social media by storm. With a signature style that blends Indian music with global club sounds, HPO has built a massive following across platforms.
              </p>
              <p style={{ color: 'rgba(209,213,219,1)', lineHeight: 1.7, fontSize: '0.95rem' }}>
                ...
                and a passionate community of music lovers. Each mashup is crafted with precision, energy, and a deep love for music.
              </p>
              <p style={{ color: 'rgba(209,213,219,1)', lineHeight: 1.7, fontSize: '0.95rem' }}>
                Whether it&apos;s electrifying wedding sets, brand promotions, or collaborations with top artists — DJ HPO brings unmatched energy to every performance.
              </p>
            </div>
